...
-(void) spawnSquares{
    ...
    _mySquare7 =[[SKSpriteNode alloc]initWithColor:[SKColor yellowColor] size:CGSizeMake(30, 30)];
    _mySquare8 =[[SKSpriteNode alloc]initWithColor:[SKColor yellowColor] size:CGSizeMake(30, 30)];
    ...
    [_mySquare5 setPosition:CGPointMake(self.size.width/1.5, self.size.height/3)];
    [_mySquare6 setPosition:CGPointMake(self.size.width/1.5, self.size.height/3)];
    [_mySquare7 setPosition:CGPointMake(self.size.width/1.5, self.size.height/3)];
